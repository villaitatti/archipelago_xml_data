...
@click.option('-h', '--host', 'host', help="the host where to upload", default='https://archipelago.itatti.harvard.edu')
...
def execute_pipeline(exec_extraction, exec_preprocessing, exec_transformation, exec_upload, exec_delete, a, limit, host):
  ...
  for file in a:
    ...
    if exec_upload or exec_delete:
      ...
      upload.execute(file, limit, exec_delete, exec_upload, host)
      print('Done.\n')
